...
- Effective history: salary, PF-rule, and salary-schedule changes; enforced final-day selection; historical impact preview; and selective manual-month replacement
...
- Data safety: protected historical PF rules/schedules, original-value audit snapshots, checksum-protected backup/restore, tamper rejection, invalid-backup rollback, and foreign keys
...
- Integration and scale: real v1/v2 database migrations, complete reporting-data backup restoration, foreign-key rollback during restore, empty-statement rejection, and forty years of monthly report aggregation
